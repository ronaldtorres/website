...
![Screenshots that shows the UI controller that many apps use to add or remove items from a list](images/add-remove-nsbox.png)
...
class SettingsAddRemoveFooter: NSBox {
