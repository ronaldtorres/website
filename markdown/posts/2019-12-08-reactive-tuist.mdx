...
Foundation has API for synchronizing asynchronous work such as dispatch semaphores and groups.
However,
...
we are starting to introduce some bits of reactive programming in Tuist using RxSwift.
...
At this point,
you might wonder why not Combine? Well, Combine is a macOS 10.15.x framework,
